<template>
  <div class="driver-qualification">
...
export default {
  ...
  data() {
    return {
      activeName: "report_driver_zone_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区汇总",
          tabName: "report_driver_zone_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业汇总",
          tabName: "report_driver_company_table", //将作为标识符来区分
      ...
      return [
        {
          ...
          tabHeader: [
            ...
            {
              headerKey: "CompanyValidCount",
              headerVal: "驾驶员资质合格企业数",
              subHeaders: [],
              columnType: this.columnType.text
            },
            {
              headerKey: "CompanyValidRate",
              headerVal: "驾驶员资质合格企业比率",
              subHeaders: [],
              columnType: this.columnType.text
            },
            {
              ...
              subHeaders: [
                ...
                {
                  headerKey: "SumValidRate",
                  headerVal: "驾驶员资质总合格率",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "CertificateValidRate",
                  headerVal: "驾驶证合格率",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "LinceseCardValidRate",
                  headerVal: "从业资格证合格率",
                  columnType: this.columnType.text
                }
              ]
          ...
          TabCtnt: [
            {
              ...
              ZoneName: "王小虎",
              CompanyCount: "上海",
              CompanyValidCount: "普陀区",
              CompanyValidRate: "上海市普陀区金沙江路 1518 弄"
            },
            {
              sybid: "2016-05-03",
              ZoneName: "王小虎",
      ...
      switch (activeName) {
        case this.tabNameObj.firTab.tabName:
          return {
            ...
            FatigueDrivInstalledRate_CHAOCHANGeRate:
              vehicleInstallItem.InstalledRate_CHAOCHANG,
      ...
      switch (activeName) {
        case this.tabNameObj.firTab.tabName:
          ...
          for (let msgItem of msg) {
            ...
            } else if (msgItem.labelId === "DeviceID")
        ...
        case this.tabNameObj.fifTab.tabName:
          ...
          for (let msgItem of msg) {
            ...
            else if (msgItem.labelId === "GPSInstalled")
