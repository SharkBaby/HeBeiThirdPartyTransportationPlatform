...
export default {
  name: "PublicityEducation",
  components: {
    MultiLevelTableComponent
  },
  data() {
    return {
      activeName: "report_education_zone_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区汇总",
          tabName: "report_education_zone_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业汇总",
          tabName: "report_education_company_table", //将作为标识符来区分
