...
export default {
  ...
  data() {
    return {
      activeName: "report_accidentreport_zonemonth_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区月报",
          tabName: "report_accidentreport_zonemonth_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业月报",
          tabName: "report_accidentreport_companymonth_table", //将作为标识符来区分
          nType: 2 //根据重构前的请求，可以看到nType 为2
        },
        thiTab: {
          tabLabel: "地区汇总",
          tabName: "report_accidentreport_zone_table", //将作为标识符来区分
          nType: 3 //根据重构前的请求，可以看到nType 为3
        },
        fouTab: {
          tabLabel: "企业汇总",
          tabName: "report_accidentreport_company_table", //将作为标识符来区分
      ...
      return [
        {
          ...
          searchCreteria: [
            ...
            },
            {
              searchType: "select",
              labelName: "事故等级:",
              labelId: reportLabelId.AccidentType, //该ID主要是用来判断在子组件中出发了哪一种个子组件
              compVal: 0,
              options: [
                {
                  value: 0,
        ...
        },
        {
          ...
          searchCreteria: [
            ...
            },
            {
              ...
              compVal: [new Date().format('yyyy-MM-dd'), new Date().format('yyyy-MM-dd')]
            },
            {
              searchType: "select",
              labelName: "事故等级:",
          ...
          tabHeader: [
            ...
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "alcoholAccCnt",
                  headerVal: "酒后驾驶",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "speedAccCnt",
                  headerVal: "超速行驶",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "tiredAccCnt",
                  headerVal: "疲劳驾驶",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "nightAccCnt",
                  headerVal: "2-5点行驶",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "troubleAccCnt",
                  headerVal: "车辆故障",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "otherAccCnt",
                  headerVal: "其他原因",
                  columnType: this.columnType.text
                }
              ]
  ...
  methods: {
    handleClickSearch: function(msg) {
      ...
      axiosRequest.axiosGet(this.getVehicleInstallDataUrl, GetVehicleInstallDataUrlParams)
    ...
    handleClickExpData: function(msg) {
      ...
      axiosRequest.axiosGet(this.exportVehicleInstallDataUrl, exportVehicleInstallDataParams)
        .then(function(response) {
