...
export default {
  ...
  data() {
    return {
      activeName: "report_safecheck_zone_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区汇总",
          tabName: "report_safecheck_zone_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业汇总",
          tabName: "report_safecheck_company_table", //将作为标识符来区分
      ...
      return [
        {
          ...
          tabHeader: [
            ...
            {
              headerKey: "qualifiedCheckRate",
              headerVal: "例保检查合格率",
              subHeaders: [],
              columnType: this.columnType.text
            },
            {
              headerKey: "qualifiedDispRate",
              headerVal: "调度安检合格率",
              subHeaders: [],
              columnType: this.columnType.text
            },
            {
              headerKey: "qualifiedDepartRate",
              headerVal: "出站合格率",
              subHeaders: [],
              columnType: this.columnType.text,
            },
          ...
          TabCtnt: [
            {
              ...
              companyCnt: "上海",
              vehicleCnt: "普陀区",
              qualifiedCheckRate: "上海市普陀区金沙江路 1518 弄"
            },
            {
              sybid: "2016-05-03",
              regionName: "王小虎",
