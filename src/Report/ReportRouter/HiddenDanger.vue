...
export default {
  ...
  data() {
    return {
      activeName: "report_hiddendanger_zone_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区汇总",
          tabName: "report_hiddendanger_zone_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业汇总",
          tabName: "report_hiddendanger_company_table", //将作为标识符来区分
      ...
      return [
        {
          ...
          searchCreteria: [
            ...
            },
            {
              ...
              compVal: new Date().format('yyyy-MM')
            }
          ],
          tabHeader: [
            {
