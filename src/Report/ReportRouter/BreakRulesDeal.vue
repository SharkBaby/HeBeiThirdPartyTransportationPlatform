...
export default {
  ...
  data() {
    return {
      activeName: "report_breakdeal_zone_table",
      activeNameIndex: 0,
      ...
      tabNameObj: {
        firTab: {
          tabLabel: "地区汇总",
          tabName: "report_breakdeal_zone_table", //将作为标识符来区分
          nType: 1 //根据重构前的请求，可以看到nType 为1
        },
        secTab: {
          tabLabel: "企业汇总",
          tabName: "report_breakdeal_company_table", //将作为标识符来区分
          nType: 2 //根据重构前的请求，可以看到nType 为2
        },
        thiTab: {
          tabLabel: "车辆汇总",
          tabName: "report_breakdeal_vehicle_table", //将作为标识符来区分
          nType: 3 //根据重构前的请求，可以看到nType 为2
        }
      }
    };
  },
      ...
      return [
        {
          ...
          tabHeader: [
            ...
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "speedIllegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "speedPunishCnt",
                  headerVal: "开单次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "speedDealCnt",
                  headerVal: "处罚次数",
                  columnType: this.columnType.text
                }
              ]
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "nightIllegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "nightPunishCnt",
                  headerVal: "开单次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "nightDealCnt",
                  headerVal: "处罚次数",
                  columnType: this.columnType.text
                }
              ]
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "gpsIllegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "gpsPunishCnt",
                  headerVal: "开单次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "gpsDealCnt",
                  headerVal: "处罚次数",
                  columnType: this.columnType.text
                }
              ]
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "tiredIllegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "tiredPunishCnt",
                  headerVal: "开单次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "tiredDealCnt",
                  headerVal: "处罚次数",
                  columnType: this.columnType.text
                }
              ]
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "classIllegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "classPunishCnt",
                  headerVal: "开单次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "classDealCnt",
                  headerVal: "处罚次数",
                  columnType: this.columnType.text
                }
              ]
            },
            {
              ...
              subHeaders: [
                {
                  headerKey: "totallegalCnt",
                  headerVal: "违章次数",
                  columnType: this.columnType.text
                },
                {
                  headerKey: "totalPunishRate",
                  headerVal: "开单率",
                  columnType: this.columnType.text
                },
                {
          ...
          TabCtnt: [
            {
              ...
              vehicleCnt: "上海",
              speedIllegalCnt: "普陀区",
              speedPunishCnt: "上海市普陀区金沙江路 1518 弄"
            },
            {
              sybid: "2016-05-03",
              regionName: "王小虎",
