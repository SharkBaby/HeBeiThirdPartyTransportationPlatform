  ...
  class="user-feedback">
    <el-form :model="ruleForm2" status-icon label-width="80px">
      ...
      <el-form-item label="联系电话: " prop="oldpass">
        <el-input v-model="ruleForm2.oldpass" auto-complete="off" placeholder="请输入您的电话号码"></el-input>
      </el-form-item>
      <el-form-item label="反馈内容: " prop="oldpass">
        <el-input type="textarea" v-model="ruleForm2.oldpass" auto-complete="off" placeholder="请输入您的反馈内容"></el-input>
      </el-form-item>
