...
function (ns) {
  ...
  //2-5
  struct.WarnInfoNightAbnormal = function () {
    struct.WarnInfoResponse.call(this);
    this.topSpeed = {
      value: 0,
      type: nType.Int32.name
    };
  ...
  //超速
  struct.WarnInfoOverSpeed = function () {
    struct.WarnInfoResponse.call(this);
    this.nowSpeed = {
      value: 0,
      type: nType.Int32.name
  ...
  //fourHours
  struct.WarnInfoFourHours = function () {
    struct.WarnInfoResponse.call(this);
    this.bAddress = {
      value: 0,
      type: nType.String.name,
  ...
  // 系统配置
  struct.Save_sysconfig = function () {
    struct.Header.call(this);
    this.sysConfigIdMonth = {
      'value': 0,
      'type': nType.Int32.name
    };

    this.configTypeMonth = {
      'value': 0,
      'type': nType.Int32.name
    };
  ...
  struct.Send_EmailExport = function () {
    struct.Header.call(this);
  }

  struct.UpdateCompany = function () {
    struct.Header.call(this);
  }
