...
const UglifyJsPlugin = require('uglifyjs-webpack-plugin') //压缩打包发布的代码
...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new webpack.optimize.ModuleConcatenationPlugin(), //这个插件会在 webpack 中实现以上的预编译功能。
    ...
    new webpack.optimize.CommonsChunkPlugin({
      name: 'vendor', //打包node_modules下面的库模块
      minChunks (module) {
    ...
    new webpack.optimize.CommonsChunkPlugin({
      name: 'manifest', //打包node_modules下面的库模块
